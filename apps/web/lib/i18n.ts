...
const en = {
  ...
  retouch: {
    ...
    off: "Off",
    select: "Select area",
    selectHint: "Click point by point around the area — a beard, the hairline. Click the first point (or double-click) to close the shape.",
    selectionPoints: (n: number) => `${n} points — keep clicking, then close the shape`,
    selectionClosed: "Selection closed — choose an effect and apply",
    effectDarken: "Darken / thicken hair",
    effectSmooth: "Smooth inside",
...
const de: Dict = {
  ...
  retouch: {
    ...
    selectHint: "Punkt für Punkt um den Bereich klicken — Bart, Haaransatz. Auf den ersten Punkt klicken (oder Doppelklick), um die Form zu schließen.",
    selectionPoints: (n) => `${n} Punkte — weiterklicken, dann die Form schließen`,
    selectionClosed: "Auswahl geschlossen — Effekt wählen und anwenden",
    effectDarken: "Haare dunkler / dichter",
    effectSmooth: "Innen glätten",
    feather: "Kantenweichheit",
...
const fa: Dict = {
  ...
  retouch: {
    ...
    off: "خاموش",
    select: "انتخاب ناحیه",
    selectHint: "نقطه به نقطه دور ناحیه بزنید — ریش، خط مو. برای بستن شکل روی نقطهٔ اول بزنید (یا دوبار کلیک کنید).",
    selectionPoints: (n) => `${n} نقطه — ادامه دهید و سپس شکل را ببندید`,
    selectionClosed: "ناحیه بسته شد — یک افکت انتخاب و اعمال کنید",
    effectDarken: "تیره‌تر / پرپشت‌تر کردن مو",
    effectSmooth: "نرم کردن داخل",
    feather: "نرمی لبه",
    applySelection: "اعمال روی ناحیه",
    clearSelection: "پاک کردن ناحیه",
...
const ps: Dict = {
  ...
  retouch: {
    ...
    off: "بند",
    select: "ساحه وټاکئ",
    selectHint: "د ساحې شاوخوا ټکی په ټکي کلیک وکړئ — ږیره، د وېښتانو کرښه. د شکل د تړلو لپاره پر لومړي ټکي کلیک وکړئ (یا دوه ځله کلیک).",
    selectionPoints: (n) => `${n} ټکي — کلیک ته دوام ورکړئ، بیا شکل وتړئ`,
    selectionClosed: "ساحه وتړل شوه — یو اغېز وټاکئ او پلی یې کړئ",
    effectDarken: "وېښتان تیاره / ګڼ کول",
    effectSmooth: "دننه نرمول",
    feather: "د څنډې نرموالی",
    applySelection: "پر ساحه پلي کړئ",
    clearSelection: "ساحه پاکه کړئ",
